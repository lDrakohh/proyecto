...
<%--
Temis :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>Temis :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/Temis.css" var="TemisCss"/>
    <link href="${TemisCss}" rel="stylesheet"/>
