package org.springframework.samples.Temis.configuration.jwt;
...
import org.springframework.samples.Temis.user.Authorities;
...
public class JwtUtils {
	...
	@Value("${Temis.app.jwtSecret}")
	private String jwtSecret;

	@Value("${Temis.app.jwtExpirationMs}")
